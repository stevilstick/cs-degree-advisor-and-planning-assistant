...
Course.create!(name: 'Computer Science 1', crn: 810765, subject: 'CS', call_number: 1050, credit_hours:4)
Course.create!(name: 'Computer Science 2', crn: 775982, subject: 'CS', call_number: 2050, credit_hours:4)
Course.create!(name: 'Principles of Algorithms', crn: 234960, subject: 'CS', call_number: 4050, credit_hours:4)
