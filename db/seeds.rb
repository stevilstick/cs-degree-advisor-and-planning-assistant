...
Course.create!(name: 'Computer Science 2', subject: 'CS', call_number: 2050, credit_hours:4)
Course.create!(name: 'Principles of Algorithms', subject: 'CS', call_number: 4050, credit_hours:4)
